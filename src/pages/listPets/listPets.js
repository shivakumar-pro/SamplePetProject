            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                <TableHead>
                    <TableRow style={{ backgroundColor: "#BDB76B", fontWeight: "bold" }}>
                        ...
                        <TableCell align="right" style={{ fontWeight: "bold" }}>Pet Id</TableCell>
                        <TableCell align="right" style={{ fontWeight: "bold" }}>Name</TableCell>
                        <TableCell align="right" style={{ fontWeight: "bold" }}>Breed</TableCell>
                        ...
                        <TableCell align="right" style={{ fontWeight: "bold" }}>Photo</TableCell>
                ...
                <TableBody style={{ backgroundColor: '#C0C0C0' }}>
                    {rows.map((row) => (
                        <TableRow
                            ...
                            <TableCell align="right">
                                <IconButton title="Delete" onClick={() => handleRemove(row.petid)}>
